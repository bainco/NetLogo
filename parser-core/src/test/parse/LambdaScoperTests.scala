...
class LambdaScoperTests extends FunSuite {
  ...
  testLambda(id("bar"),   arguments(),      newTokenIs = sameToken,         newStateIs = transition(arguments("bar")))
  testLambda(id("baz"),   arguments("bar"), newTokenIs = sameToken,         newStateIs = transition(arguments("bar", "baz")))
